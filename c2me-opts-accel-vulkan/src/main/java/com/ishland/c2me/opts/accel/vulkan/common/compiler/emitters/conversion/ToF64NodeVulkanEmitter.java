...
public class ToF64NodeVulkanEmitter implements VulkanCEmitter<ToF64Node> {
    public static final ToF64NodeVulkanEmitter INSTANCE = new ToF64NodeVulkanEmitter();

    private ToF64NodeVulkanEmitter() {
    }

    @Override
    public String doGen(ToF64Node node, VulkanGenFunctionContext context, String storeTo) {

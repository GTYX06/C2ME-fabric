...
public class VKBlockStateMappings {
    ...
    public static VKBlockStateMappings defaultMappings(BlockState defaultBlock, BlockState defaultFluid) {
        ...
        return new VKBlockStateMappings(states.toArray(BlockState[]::new));
    }

    private final BlockState[] idToBlockState;
    private final Object2IntMap<BlockState> blockStateToId;

    public VKBlockStateMappings(BlockState[] idToBlockState) {

...
public class RootNodeVulkanEmitter implements VulkanCEmitter<RootNode> {
    public static final RootNodeVulkanEmitter INSTANCE = new RootNodeVulkanEmitter();

    private RootNodeVulkanEmitter() {
    }

    @Override
    public String doGen(RootNode node, VulkanGenFunctionContext context, String storeTo) {

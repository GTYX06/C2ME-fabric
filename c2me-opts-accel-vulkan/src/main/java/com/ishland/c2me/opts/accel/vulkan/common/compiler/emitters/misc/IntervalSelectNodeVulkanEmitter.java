...
public class IntervalSelectNodeVulkanEmitter implements VulkanCEmitter<IntervalSelectNode> {
    public static final IntervalSelectNodeVulkanEmitter INSTANCE = new IntervalSelectNodeVulkanEmitter();

    private IntervalSelectNodeVulkanEmitter() {
    }

    @Override
    public String doGen(IntervalSelectNode node, VulkanGenFunctionContext context, String storeTo) {
    ...
    private static String genBinarySearch(double[] thresholds, Object[] delegates, boolean emitFunctions, VulkanGenFunctionContext context, int fromIndex, int toIndex) {
        ...
        StringBuilder sb = new StringBuilder();
        sb.append("if (v < ").append(VulkanGen.literal(midVal)).append(") {\n");
    ...
    private static void emitCall(Object[] delegates, VulkanGenFunctionContext context, int idx, StringBuilder sb, boolean emitFunctions) {

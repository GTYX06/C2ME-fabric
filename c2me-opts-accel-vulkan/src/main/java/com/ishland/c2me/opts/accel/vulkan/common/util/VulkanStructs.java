...
public class VulkanStructs {
    ...
    public static MemorySegment fluidLevelSamplerCreate(Arena arena, int minimumY, int height, AquiferSampler.FluidLevelSampler fluidLevelSampler, VKBlockStateMappings mappings) {

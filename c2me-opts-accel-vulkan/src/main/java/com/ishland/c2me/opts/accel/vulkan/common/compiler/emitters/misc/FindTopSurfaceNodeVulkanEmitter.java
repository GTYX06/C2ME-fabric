...
public class FindTopSurfaceNodeVulkanEmitter implements VulkanCEmitter<FindTopSurfaceNode> {
    public static final FindTopSurfaceNodeVulkanEmitter INSTANCE = new FindTopSurfaceNodeVulkanEmitter();

    private FindTopSurfaceNodeVulkanEmitter() {
    }

    @Override
    public String doGen(FindTopSurfaceNode node, VulkanGenFunctionContext context, String storeTo) {
        ...
        if (densityMethod.isConst()) {
            b.append(VulkanGen.literal(densityMethod.constValue()));
        } else {

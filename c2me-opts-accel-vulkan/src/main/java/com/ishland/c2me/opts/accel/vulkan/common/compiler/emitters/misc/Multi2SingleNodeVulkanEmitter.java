...
public class Multi2SingleNodeVulkanEmitter implements VulkanCEmitter<Multi2SingleNode> {
    public static final Multi2SingleNodeVulkanEmitter INSTANCE = new Multi2SingleNodeVulkanEmitter();

    private Multi2SingleNodeVulkanEmitter() {
    }

    @Override
    public String doGen(Multi2SingleNode node, VulkanGenFunctionContext context, String storeTo) {

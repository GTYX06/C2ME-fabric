...
public class SplineNormalNodeVulkanEmitter implements VulkanCEmitter<SplineNormalNode> {
    public static final SplineNormalNodeVulkanEmitter INSTANCE = new SplineNormalNodeVulkanEmitter();

    private SplineNormalNodeVulkanEmitter() {
    }

    @Override
    public String doGen(SplineNormalNode node, VulkanGenFunctionContext context, String storeTo) {

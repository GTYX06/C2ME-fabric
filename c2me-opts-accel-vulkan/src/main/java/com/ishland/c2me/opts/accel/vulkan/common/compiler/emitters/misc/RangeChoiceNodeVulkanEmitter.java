...
public class RangeChoiceNodeVulkanEmitter implements VulkanCEmitter<RangeChoiceNode> {
    public static final RangeChoiceNodeVulkanEmitter INSTANCE = new RangeChoiceNodeVulkanEmitter();

    private RangeChoiceNodeVulkanEmitter() {
    }

    @Override
    public String doGen(RangeChoiceNode node, VulkanGenFunctionContext context, String storeTo) {
    ...
    private static void emitCall(VulkanGenFunctionContext context, AstNode node, StringBuilder sb, String storeTo) {
        if (!Config.preserveAllControlFlows) {

...
import com.ishland.c2me.opts.accel.vulkan.common.workarounds.intel.IntelWorkarounds;
import com.ishland.c2me.opts.accel.vulkan.common.workarounds.mesa.MesaWorkarounds;
import com.ishland.c2me.opts.accel.vulkan.common.workarounds.nvidia.NvidiaWorkarounds;
...
public class Workarounds {
    ...
    public static Set<Reference> getWorkarounds(VulkanDeviceMetadata metadata) {
        ...
        if (Boolean.getBoolean("com.ishland.c2me.opts.accel.vulkan.markBuiltinTrapBroken")) {
            set.add(Reference.BUILTIN_TRAP_BROKEN);
        }
    ...
    public enum Reference {
        ...
        /**
         * Nvidia ships incomplete Vulkan 3.0 implementation
         * Stuff broken:

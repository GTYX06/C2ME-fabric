...
public class GenericShiftedNoiseNodeVulkanEmitter implements VulkanCEmitter<GenericShiftedNoiseNode> {
    public static final GenericShiftedNoiseNodeVulkanEmitter INSTANCE = new GenericShiftedNoiseNodeVulkanEmitter();

    private GenericShiftedNoiseNodeVulkanEmitter() {
    }

    @Override
    public String doGen(GenericShiftedNoiseNode node, VulkanGenFunctionContext context, String storeTo) {
